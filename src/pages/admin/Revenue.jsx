...
import { BadgeCheck, Trash2, SearchIcon, DollarSign, X, FileBarChart2, Settings, ArrowRightCircleIcon, ClipboardCheck, UserX, Users, ShoppingCart, UserCheck, Headphones, Eye } from "lucide-react";
                    ...
                    <div>
                        <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
                            <div className="text-center sm:text-left">
                                <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Total Revenue</h1>
                                <p className="text-md font-semibold mb-6 text-gray-700 dark:text-gray-300">
                                    Here you can view the total revenue generated from all sales.
                                </p>
                            </div>
                            <div>
                                <button 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                            {
                                stats.map((stat, index) => (
                                    <div 
                                        key={index} 
                                        className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow transition-colors duration-300">
